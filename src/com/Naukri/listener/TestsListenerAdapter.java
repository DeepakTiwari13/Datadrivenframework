...
public class TestsListenerAdapter implements IInvokedMethodListener {
	...
	static Logger Naukri_Logs = Logger.getLogger("TestsListenerAdapter");
	
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		Reporter.setCurrentTestResult(result);
		Naukri_Logs.info("*************TestsListenerAdapter******************");

		if (method.isTestMethod()) {
			List<Throwable> verificationFailures = com.Naukri.util.ErrorUtil.getVerificationFailures();
