...
public class Xls_Reader {
	...
	public Logger Framework_Logs = Logger.getLogger("Xls_Reader");
	...
	public Xls_Reader(String path) {
		Framework_Logs.info("Inside Xls_Reader constructor");
	...
	public Xls_Reader getInstance() {
		...
		Framework_Logs.info("Inside Xls_Reader single ton class");
	...
	public boolean removeColumn(String sheetName, int colNum) {
		try {
			...
			style.setFillForegroundColor(HSSFColor.GREY_40_PERCENT.index);
			XSSFCreationHelper createHelper = workbook.getCreationHelper();
			Framework_Logs.info("Inside Xls_Reader remove column function "+createHelper.toString());
